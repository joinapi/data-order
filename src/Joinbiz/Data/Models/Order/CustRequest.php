...
class CustRequest extends Model
{
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Common\Uom', 'maximum_amount_uom_id', 'uom_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Party\ContactMech', 'fulfill_contact_mech_id', 'contact_mech_id');
    }
