...
class OrderItemChange extends Model
{
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Common\Enumeration', 'change_type_enum_id', 'enum_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Security\UserLogin', 'change_user_login', 'user_login_id');
    }
}
