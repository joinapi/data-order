...
class ReturnHeader extends Model
{
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Shipment\Shipment', 'primary_return_id', 'return_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Party\ContactMech', 'origin_contact_mech_id', 'contact_mech_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Party\Party', 'from_party_id', 'party_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Product\Facility', 'destination_facility_id', 'facility_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Party\Party', 'to_party_id', 'party_id');
    }
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Marketing\TrackingCodeOrderReturn', 'return_id', 'return_id');
    }
}
