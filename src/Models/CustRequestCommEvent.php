 ...
 */
class CustRequestCommEvent extends Model
{
     ...
     * @var string
     */
    protected $table = 'cust_request_comm_event';
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Order\CommunicationEvent', 'communication_event_id', 'communication_event_id');
    }
