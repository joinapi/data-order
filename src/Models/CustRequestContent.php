 ...
 */
class CustRequestContent extends Model
{
     ...
     * @var string
     */
    protected $table = 'cust_request_content';
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Order\Content', 'content_id', 'content_id');
    }
