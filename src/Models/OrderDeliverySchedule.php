...
class OrderDeliverySchedule extends Model
{
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Order\Uom', 'total_cubic_uom_id', 'uom_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Order\Uom', 'total_weight_uom_id', 'uom_id');
    }
}
