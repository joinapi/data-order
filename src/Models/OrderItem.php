...
class OrderItem extends Model
{
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Order\UserLogin', 'dont_cancel_set_user_login', 'user_login_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Order\InventoryItem', 'from_inventory_item_id', 'inventory_item_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Order\Uom', 'recurring_freq_uom_id', 'uom_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Order\SalesOpportunity', 'sales_opportunity_id', 'sales_opportunity_id');
    }
