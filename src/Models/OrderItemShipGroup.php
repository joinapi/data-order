...
class OrderItemShipGroup extends Model
{
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Order\Party', 'carrier_party_id', 'party_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Order\PostalAddress', 'contact_mech_id', 'contact_mech_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Order\Agreement', 'supplier_agreement_id', 'agreement_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Order\ShipmentMethodType', 'shipment_method_type_id', 'shipment_method_type_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Order\Party', 'supplier_party_id', 'party_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Order\TelecomNumber', 'telecom_contact_mech_id', 'contact_mech_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Order\ContactMech', 'telecom_contact_mech_id', 'contact_mech_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Order\Party', 'vendor_party_id', 'party_id');
    }
}
