...
class OrderPaymentPreference extends Model
{
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Order\Payment', 'payment_preference_id', 'order_payment_preference_id');
    }
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Order\PaymentGatewayResponse', 'order_payment_preference_id', 'order_payment_preference_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Order\PaymentMethodType', 'payment_method_type_id', 'payment_method_type_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Order\ProductPricePurpose', 'product_price_purpose_id', 'product_price_purpose_id');
    }
