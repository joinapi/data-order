...
class ShoppingList extends Model
{
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Order\ProductPromoCode', 'product_promo_code_id', 'product_promo_code_id');
    }
    ...
    {
        return $this->belongsTo('Joinbiz\Data\Models\Order\RecurrenceInfo', 'recurrence_info_id', 'recurrence_info_id');
    }
